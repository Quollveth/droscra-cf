/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b44c10e76d9b0f41145ebc49b646603e)
// Runtime types generated with workerd@1.20250507.0 2025-05-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DB_TOKEN: string;
		DROSCRA_OBJ: DurableObjectNamespace<import("./src/server/index").DroscraObj>;
		MYBROWSER: Fetcher;
		assets: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DB_TOKEN">> {}
}

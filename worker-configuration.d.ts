/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2650324e076c2214c41dc400be9507e3)
// Runtime types generated with workerd@1.20250507.0 2025-05-07 nodejs_compat_v2
declare namespace Cloudflare {
	interface Env {
		DB_TOKEN: string;
		DROSCRA_OBJ: DurableObjectNamespace<import('./src/server/index').DroscraObj> /* DroscraObj */;
		BROWSER: Fetcher;
		assets: Fetcher;
	}
}
